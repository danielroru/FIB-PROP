...
public class CliquePercolation extends Algorithm {
    ...
    private void determinar_w (Graph<Integer,Double> g) {
        ...
        double Q1 = (pes_min+mitja_pes)/2;   // Primer cuartil
        double Q12 = (Q1+mitja_pes)/2;      // Primer cuartil y un poco mas
        double Q3 = (pes_max+mitja_pes)/2;   // Tercer cuartil
        double factor = super.p/100.;
        W = (Q3*factor + Q12*(1-factor));
    }
