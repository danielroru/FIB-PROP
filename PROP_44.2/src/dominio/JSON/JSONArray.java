...
/**
 * A dominio.JSON array. JSONObject supports java.util.List interface.
 * 
...
public class JSONArray extends ArrayList implements JSONAware, JSONStreamAware {
    ...
    /**
     * Encode a list into dominio.JSON text and write it to out.
	...
	/**
	 * Convert a list to dominio.JSON text. The result is a dominio.JSON array.
	 * If this list is also a JSONAware, JSONAware specific behaviours will be omitted at this top level.
	 * 
	 * @see JSONValue#toJSONString(Object)
	 * 
	 * @param collection
	 * @return dominio.JSON text, or "null" if list is null.
	 */
