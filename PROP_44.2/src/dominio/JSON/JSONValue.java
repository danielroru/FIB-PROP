...
public class JSONValue {
	/**
	 * Parse dominio.JSON text into java object from the input source.
	...
	/**
	 * Parse dominio.JSON text into java object from the given string.
	 * Please use parseWithException() if you don't want to ignore the exception.
	 * 
	 * @see JSONParser#parse(Reader)
	 * @see #parseWithException(Reader)
    ...
    /**
     * Encode an object into dominio.JSON text and write it to out.
     * <p>
	...
	/**
	 * Convert an object to dominio.JSON text.
	 * <p>
	 ...
	 * 
	 * @param value
	 * @return dominio.JSON text, or "null" if value is null or it's an NaN or an INF number.
	 */
