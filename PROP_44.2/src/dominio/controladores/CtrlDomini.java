...
public class CtrlDomini {
    ...
    public static void modificarHorari() {
        try {
            inout io = new inout();

            io.write("Dades de les dues caselles a intercanviar");
            UAH uah1, uah2;
            for (int i = 0; i < 2; ++i) {
                io.write("Dia");
                String dia = io.readline();
                io.write("Hora");
                String hora = io.readline();
                io.write("Aula");
                String aula = io.readline();
                io.write("Dia");
                String dia2 = io.readline();
                io.write("Hora");
                String hora2 = io.readline();
                io.write("Aula");
                String aula2 = io.readline();
