...
public class Assignatura {
    ...
    private Set<String> correquisits;
    ...
    public Assignatura(String nom, int nHoresT, int nHoresL, int nHoresP,
                       ...
                       int nGrupsMati, int horesBlocT, int horesBlocL, int horesBlocP, int nivell, Set<String> correquisits) {
    ...
    public Set<String> getCorrequisits() { return this.correquisits; }
    ...
    public void setCorrequisits(Set<String> correquisits) {this.correquisits = correquisits; }
}
